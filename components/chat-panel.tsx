    ...
    <div className="space-y-6">
      {messages.map((message) => (
        ...
        >
          <div
            className={cn(
              "max-w-[90%] rounded-[26px] border p-5 shadow-lg shadow-black/10 sm:max-w-[82%]",
              message.role === "user"
                ? "border-[var(--accent)]/20 bg-[linear-gradient(135deg,rgba(196,164,107,0.18),rgba(196,164,107,0.08))]"
      ...
      {isLoading ? (
        <article className="flex justify-start">
          <div className="max-w-[82%] rounded-[26px] border border-white/10 bg-white/[0.045] p-5">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)]">Preparing a response</p>
              </div>
            </div>
            <LoadingDots />
          </div>
